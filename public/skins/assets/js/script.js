...
$(document).ready(function () {
    ...
    function fixHeight() {
        ...
        console.log(body, top, highlighted, content, footer);
        if (body > top + highlighted + content + footer) {
            //$('main').height(body - header - footer - 5);
            var newHeight = body - top - highlighted - footer - 5;
            var style = 'min-height:' + newHeight + 'px;';
